...
const INFURA_URL = 'https://polygon-mumbai.g.alchemy.com/v2/4kxoR12KYqX4yIsX9Wq0tGAld44toDRm'

const provider = new ethers.providers.JsonRpcProvider(INFURA_URL)
const poolAddress = '0xD0F73ebe170462F45D49c0DfED8E89E2c6294ee9'
...
const connectedWallet = wallet.connect(provider);
  ...
  const getPoolImmutables = async (poolContract:any) => {
...
const getPrice = async (inputAmount: number) => {
  ...
  console.log("Token 1 symbol:=>", tokenSymbol0);
  const tokenSymbol1 = await tokenContract1.symbol()
  console.log("Token 2 symbol:=>", tokenSymbol1);
  const tokenDecimals0 = await tokenContract0.decimals()
  console.log("Token 1 decimal:=>", tokenDecimals0);
  const tokenDecimals1 = await tokenContract1.decimals()
  console.log("Token 2 decimal:=>", tokenDecimals1);
  ...
  console.log("Immutables Value:=.",immutables);
  ...
  const quotedAmountOut = await quoterContract.connect(connectedWallet).callStatic.quoteExactInputSingle(
    immutables.token0,
    immutables.token1,
    immutables.fee,
    amountIn,
